...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/home/dirkb/bin/wasi-sdk/bin/llvm-ar',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': '/home/dirkb/bin/wasi-sdk/bin/wasm-ld',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '.wasm',
 'BUILDPYTHON': 'python.wasm',
 'BUILD_GNU_TYPE': 'x86_64-pc-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': '/home/dirkb/bin/wasi-sdk/bin/clang '
       '--sysroot=/home/dirkb/bin/wasi-sdk/share/wasi-sysroot',
 'CCSHARED': '',
 ...
 'CONFIG_ARGS': "'-C' '--host=wasm32-unknown-wasi' "
                ...
                "'--with-build-python=/home/dirkb/Projects/python/cpython/builddir/build/python' "
                "'CONFIG_SITE=/home/dirkb/Projects/python/cpython/Tools/wasm/config.site-wasm32-wasi' "
                "'build_alias=x86_64-pc-linux-gnu' "
                "'host_alias=wasm32-unknown-wasi' 'PKG_CONFIG_PATH=' "
                "'PKG_CONFIG_LIBDIR=/home/dirkb/bin/wasi-sdk/share/wasi-sysroot/lib/pkgconfig:/home/dirkb/bin/wasi-sdk/share/wasi-sysroot/share/pkgconfig' "
                "'CC=/home/dirkb/bin/wasi-sdk/bin/clang "
                "--sysroot=/home/dirkb/bin/wasi-sdk/share/wasi-sysroot' "
                "'CPP=/home/dirkb/bin/wasi-sdk/bin/clang-cpp "
                "--sysroot=/home/dirkb/bin/wasi-sdk/share/wasi-sysroot' "
                "'HOSTRUNNER=wasmtime run --env "
                'PYTHONPATH=/builddir/wasi/build/lib.wasi-wasm32-3.11:/Lib '
                "--mapdir /::/home/dirkb/Projects/python/cpython --'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/dirkb/Projects/python/cpython/builddir/wasi/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/dirkb/Projects/python/cpython/builddir/wasi/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.11 LCOV report [commit $(shell '
                            'git --git-dir ../../.git rev-parse --short '
                            'HEAD)]"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../../Include',
 'CXX': '/home/dirkb/bin/wasi-sdk/bin/clang++ '
        '--sysroot=/home/dirkb/bin/wasi-sdk/share/wasi-sysroot',
 ...
 'FREEZE_MODULE': '/home/dirkb/Projects/python/cpython/builddir/build/python '
                  '../../Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/home/dirkb/Projects/python/cpython/builddir/build/python '
                            '../../Programs/_freeze_module.py',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/home/dirkb/bin/wasi-sdk/bin/wasm-ld',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/home/dirkb/bin/wasi-sdk/bin/wasm-ld',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/home/dirkb/bin/wasi-sdk/bin/clang '
           '--sysroot=/home/dirkb/bin/wasi-sdk/share/wasi-sysroot',
 'LINKFORSHARED': '',
 ...
 'LOCALMODLIBS': '-lm -lm -lm -lm -lm -lm '
                 'Modules/_decimal/libmpdec/libmpdec.a        -lm '
                 'Modules/expat/libexpat.a',
 'MACHDEP': 'wasi',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/local/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': '/home/dirkb/bin/wasi-sdk/bin/clang '
           '--sysroot=/home/dirkb/bin/wasi-sdk/share/wasi-sysroot',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODBUILT_NAMES': 'array  _asyncio  _bisect  _contextvars  _csv  _heapq  '
                   ...
                   '_statistics  _datetime  _decimal  binascii  _md5  _sha1  '
                   '_sha256  _sha512  _sha3  _blake2  pyexpat  _elementtree  '
                   '_codecs_cn  _codecs_hk  _codecs_iso2022  _codecs_jp  '
                   '_codecs_kr  _codecs_tw  _multibytecodec  unicodedata  '
                   '_crypt  select  _socket  _xxtestfuzz  _testbuffer  '
                   '_testinternalcapi  _testcapi  _testclinic  atexit  '
 ...
 'MODOBJS': 'Modules/arraymodule.o  Modules/_asynciomodule.o  '
            ...
            'Modules/_testclinic.o  Modules/atexitmodule.o  '
 ...
 'MODULE__SSL_DEPS': '../../Modules/_ssl.h ../../Modules/_ssl/cert.c '
                     ...
                     '../../Modules/_ssl/misc.c ../../Modules/_ssl_data.h '
 ...
 'PYTHON_FOR_BUILD': "_PYTHON_HOSTRUNNER='wasmtime run --env "
                     'PYTHONPATH=/builddir/wasi/build/lib.wasi-wasm32-3.11:/Lib '
                     "--mapdir /::/home/dirkb/Projects/python/cpython --' "
                     '_PYTHON_PROJECT_BASE=/home/dirkb/Projects/python/cpython/builddir/wasi '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/home/dirkb/Projects/python/cpython/builddir/wasi/`cat '
                     'pybuilddir.txt`:)../../Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi '
                     '/home/dirkb/Projects/python/cpython/builddir/build/python',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/home/dirkb/Projects/python/cpython/builddir/build/python',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': "_PYTHON_HOSTRUNNER='wasmtime run --env "
               'PYTHONPATH=/builddir/wasi/build/lib.wasi-wasm32-3.11:/Lib '
               "--mapdir /::/home/dirkb/Projects/python/cpython --' "
               '_PYTHON_PROJECT_BASE=/home/dirkb/Projects/python/cpython/builddir/wasi '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               ...
               '/home/dirkb/Projects/python/cpython/builddir/build/python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': "_PYTHON_HOSTRUNNER='wasmtime run --env "
               'PYTHONPATH=/builddir/wasi/build/lib.wasi-wasm32-3.11:/Lib '
               "--mapdir /::/home/dirkb/Projects/python/cpython --' "
               '_PYTHON_PROJECT_BASE=/home/dirkb/Projects/python/cpython/builddir/wasi '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
 ...
 'abs_builddir': '/home/dirkb/Projects/python/cpython/builddir/wasi',
 'abs_srcdir': '/home/dirkb/Projects/python/cpython/builddir/wasi/../..',
